...
| **Cline**                  | `.clinerules/workflows/`               | Markdown | N/A (IDE-based) | Cline VS Code extension     |
...
- **Cline**: Built into VS Code (Cline extension)

## Command File Formats

### Markdown Format

Used by: Claude, Cursor, opencode, Windsurf, Amazon Q Developer, Amp, SHAI, IBM Bob, Cline
